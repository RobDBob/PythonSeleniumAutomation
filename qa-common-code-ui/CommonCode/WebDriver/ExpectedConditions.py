...
def _element_if_visible(element, visibility=True):
    if visibility:
        return element if element and element.is_displayed() else False
    else:
...
class visibility_of_just_one_element_located(object):
    ...
    def __call__(self, driver):
        try:
            ...
            if element and element.text:
                ...
                element_text_no_spaces  = element.text.replace(' ', '')
                text_no_spaces = self.text.replace(' ', '')

                return text_no_spaces in element_text_no_spaces
            else:
                return False
        except StaleElementReferenceException:
                return False
